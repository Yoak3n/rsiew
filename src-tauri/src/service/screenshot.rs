...
#[cfg(target_os = "linux")]
use super::linux_session::{current_linux_desktop_environment, current_linux_desktop_session};
#[cfg(any(target_os = "linux", test))]
use super::linux_session::{LinuxDesktopEnvironment, LinuxDesktopSession};
...
impl ScreenshotService {
    ...
    pub fn capture_for_window(
        &self,
        active_window: Option<&crate::service::monitor::ActiveWindow>,
    ...
    pub fn capture_for_window(
        &self,
        _active_window: Option<&crate::service::monitor::ActiveWindow>,
    ) -> Result<ScreenshotResult> {
        self.capture_impl()
    }
...
mod tests {
    ...
    use crate::config::{ScreenshotDisplayMode, ScreenshotWidthMode, StorageConfig};
    use crate::service::linux_session::{LinuxDesktopEnvironment, LinuxDesktopSession};
    use crate::service::monitor::{ActiveWindow, WindowBounds};
