...
<template>
  <main class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/50 p-6 sm:p-8 text-gray-800">
    <div class="max-w-4xl mx-auto">
      <header class="mb-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-0">
        <div>
          <h1 class="text-4xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">rsiew</h1>
          <p class="text-gray-500 mt-1">Personal Work Dynamics Monitor</p>
        </div>
        <div class="bg-gradient-to-br from-blue-500 to-indigo-600 px-6 py-5 rounded-2xl shadow-lg shadow-blue-500/25 text-center min-w-[160px]">
      ...
      <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl shadow-gray-200/50 border border-white/50 overflow-hidden">
        <div class="px-6 py-5 border-b border-gray-100/80 bg-gradient-to-r from-gray-50/80 to-blue-50/50 flex justify-between items-center">
        ...
        <div class="p-0">
          <ul class="divide-y divide-gray-100/80">
            <li v-for="(item, index) in stats" :key="index" class="px-6 py-4 hover:bg-gradient-to-r hover:from-blue-50/40 hover:to-indigo-50/40 transition-all duration-200 group">
